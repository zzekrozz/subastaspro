...
export const courseModules = [
  ...
  },
  {
    ...
    duration: "13 min",
    summary: "Copart, para mí, es hoy una de las subastas más rentables que hay. Pero cuando digo Copart, me refiero especialmente a Copart Alemania.",
    learning: [
    ...
    quote: "Copart no es una subasta para comprar cualquier coche barato. Es una subasta para comprar coches con daño o riesgo, pero por debajo de mercado, siempre que sepas analizar bien.",
    miniChecklist: [
    ...
    sections: [
      {
        title: "Idea principal del módulo",
        paragraphs: [
          "Copart, para mí, es hoy una de las subastas más rentables que hay. Pero cuando digo Copart, me refiero especialmente a Copart Alemania.",
          "Copart cada vez está abriendo más sucursales y va creciendo, pero dentro de Europa, ahora mismo, la más interesante con gran diferencia es Alemania.",
          "¿Por qué? Porque normalmente los precios están por debajo del mercado alemán. Y si un coche ya está por debajo del mercado alemán, muchas veces significa que está muy por debajo del mercado español.",
          "Eso no quiere decir que todo sea rentable ni que todo valga. Copart es una subasta de vehículos dañados, y ahí hay que saber mirar. Hay coches con daños de carrocería, daños mecánicos, vehículos con desgaste normal, coches con documentación complicada, coches con daños importantes y también oportunidades muy buenas.",
      ...
      },
      {
        ...
        callout: {
          tone: "note",
          label: "Idea clave",
          text: "Copart no es una subasta para comprar cualquier coche barato. Es una subasta para comprar coches con daño o riesgo, pero por debajo de mercado, siempre que sepas analizar bien."
        }
      },
      {
        title: "2. Por qué Copart Alemania es tan interesante",
        paragraphs: [
          "La parte más interesante de Copart en Europa, para mí, es Alemania.",
          "Alemania tiene mucho mercado, mucha rotación, mucho vehículo y precios que pueden ser bastante atractivos si los comparas con España.",
          "Lo importante es entender esta idea:",
          "Si un coche está barato respecto al mercado alemán, muchas veces puede estar muy barato respecto al mercado español.",
          "Ten en cuenta que cuando le compras un vehículo a una compraventa alemana para importarlo a España, es muy probable que ese vehículo venga también de una subasta.",
      ...
      {
        title: "3. Coste anual de Copart",
        paragraphs: [
          "Copart tiene un coste anual si quieres registrarte, ver precios y participar en subastas.",
          "La licencia de miembro anual puede rondar aproximadamente los 200 €.",
          "Puede parecer una barrera al principio, pero si realmente vas a buscar coches en subasta, merece la pena.",
          "Con una sola operación buena, ese coste puede quedar más que compensado.",
          "También han implementado hace poco acceso para particulares, pero es bastante limitado. Por lo que he visto, no puedes pujar por todos los coches y puede que solo puedas pujar por un coche a la vez.",
          "Aun así, para empezar, puede servir. Pero si quieres trabajar Copart de forma más seria, lo normal es tener acceso profesional y entender bien las condiciones de la plataforma."
        ],
        callout: {
          tone: "note",
          label: "Consejo útil",
          text: "No mires la licencia anual como gasto aislado. Mírala como acceso a oportunidades. Si vas a usar Copart de verdad, el coste puede tener sentido."
        }
      },
      {
        title: "4. Días de subasta en Alemania",
        paragraphs: [
          "En Copart Alemania hay subastas de lunes a viernes.",
          "Sábado, domingo y festivos normalmente son días de descanso.",
          "Esto es importante porque puedes organizar tu semana alrededor de las subastas.",
      ...
      },
      {
        ...
        images: [
          {
            src: "/course-images/copart/r-s-sin-indicador-copart.jpg",
            alt: "Captura de la lista de Copart con R, S y sin indicador",
            caption: "Placeholder: zona de la lista donde se ve la R en verde, la S en azul o la ausencia de indicador."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        images: [
          {
            src: "/course-images/copart/estimated-retail-value-copart.jpg",
            alt: "Captura del Estimated Retail Value en la lista de Copart",
            caption: "Placeholder: campo de kilometraje y Estimated Retail Value visible en la lista o ficha rápida."
          }
        ]
      },
      {
        ...
        images: [
          {
            src: "/course-images/copart/zb1-zb2-coc-copart.jpg",
            alt: "Captura de ZB1, ZB2 y COC en Copart",
            caption: "Placeholder: documentación alemana visible con referencia a ZB1, ZB2 o Certificate of Conformity."
          }
        ]
      },
      {
        ...
        images: [
          {
            src: "/course-images/copart/international-documents-copart.jpg",
            alt: "Captura de International Documents en Copart",
            caption: "Placeholder: indicador de International Documents o documentación fuera de Alemania."
          }
        ]
      },
      {
        ...
        images: [
          {
            src: "/course-images/copart/dano-principal-lista-copart.jpg",
            alt: "Captura del daño principal declarado en la lista de Copart",
            caption: "Placeholder: tipo de daño principal visible en la lista, como mechanical, front end o normal wear."
          }
        ]
      },
      {
  ...
  },
  {
    ...
    quote: "Copart puede ser muy rentable, pero si pujas con emoción en vez de con números, puedes convertir una buena oportunidad en una compra mediocre.",
    miniChecklist: [
      ...
      "¿Tengo claro el pago en 48 horas?",
      "¿Tengo claro que hay 5 días laborables para recoger?",
      "¿El coche puede circular?",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Copart puede ser muy rentable, pero si pujas con emoción en vez de con números, puedes convertir una buena oportunidad en una compra mediocre."
        ]
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Te muestra cuánto más vas a pujar.",
          "Normalmente, las pujas suben de 100 en 100 €.",
          "En precios más pequeños, puede ir de:",
          "• 25 en 25 €;",
          "• 50 en 50 €;",
          "• 100 en 100 €.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Por ejemplo, si ganas la subasta por 6.000 €, puedes terminar pagando aproximadamente 6.795 € después de comisiones.",
          "La cifra exacta puede cambiar, por eso conviene usar la calculadora oficial.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Si lo ganas por 6.500 €, la comisión puede rondar 800 €, y con 2.000 € de gastos estarías aproximadamente en 9.300 €.",
          "Ahí todavía hay beneficio.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "El vendedor tampoco puede estar infinitamente diciendo que no y esperando siempre su precio ideal. Según tengo entendido, si rechaza varias veces, puede haber consecuencias o comisiones para él, lo que le empuja a cerrar más tratos.",
          "Aquí depende de cuánto quieras el coche.",
          "Si no es una megaganga, yo no subiría mucho o directamente no subiría nada.",
          "Hay subastas de lunes a viernes y coches nuevos cada semana.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Normalmente tienes 48 horas para que el dinero esté en su cuenta.",
          "Por eso, lo mejor es hacer transferencia inmediata y mandar justificante por email.",
          "Después tienes 5 días laborables para recoger el vehículo.",
          "Aquí meten bastante prisa.",
          "Si pasan esos 5 días, empiezan a cobrar almacenamiento diario más IVA.",
